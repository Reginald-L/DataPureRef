...
- **📁 多媒体管理**
  ...
  - **图片 & 视频**：支持拖拽上传、自由缩放和移动；图片支持在缩略图与原始尺寸之间双击切换，展开后自动置顶显示；视频支持双击快速恢复原始比例。
...
| **图片预览切换** | **双击** 图片可在缩略图和原始尺寸之间切换；放大后会自动置顶显示 |
| **恢复缩略图** | 选中已放大的图片后按 **Esc**，可快速恢复到缩略图尺寸 |
| **视频重置大小** | **双击** 视频对象可快速恢复原始比例 |
